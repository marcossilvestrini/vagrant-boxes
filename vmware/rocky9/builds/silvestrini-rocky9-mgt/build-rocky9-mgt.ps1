...
.DESCRIPTION
    Requirments: none
    Description: Script for build custom vagrant box silvestrini-rocky9-mgt
...
$pathBuild="$scriptPath\builds\silvestrini-rocky9-mgt"
$customBoxName="silvestrini-rocky9-mgt"
