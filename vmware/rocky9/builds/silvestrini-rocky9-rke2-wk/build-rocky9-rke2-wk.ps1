...
.DESCRIPTION
    Requirments: none
    Description: Script for build custom vagrant box silvestrini-rocky9-wk
...
$pathBuild="$scriptPath\builds\silvestrini-rocky9-rke2-wk"
$customBoxName="silvestrini-rocky9-rke2-wk"
