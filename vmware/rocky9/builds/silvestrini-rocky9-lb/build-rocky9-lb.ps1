...
.DESCRIPTION
    Requirments: none
    Description: Script for build custom vagrant box silvestrini-rocky9-lb
...
$pathBuild="$scriptPath\builds\silvestrini-rocky9-lb"
$customBoxName="silvestrini-rocky9-lb"
