...
.DESCRIPTION
    Requirments: none
    Description: Script for build custom vagrant box silvestrini-rocky9-cp
...
$pathBuild="$scriptPath\builds\silvestrini-rocky9-rke2-cp"
$customBoxName="silvestrini-rocky9-rke2-cp"
...
| ForEach-Object{
    Write-Host "Execute vdiskmanager -R..."
    & $vdiskmanager -R "$_"
    Write-Host "Execute vdiskmanager -d..."
    & $vdiskmanager -d "$_"
    Write-Host "Execute vdiskmanager -k..."
    & $vdiskmanager -k "$_"
}
