...
$pathBuild="$scriptPath\builds\silvestrini-ol9-mgt"
$customBoxName="silvestrini-ol9-mgt"
...
& "C:\Program Files\Git\mingw64\bin\dos2unix.exe" $scriptPath\scripts\linux\salt\*
